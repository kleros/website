					...
					<div className="container">
						<div className="row">
							...
							<div className="col-12 col-md-10">
								...
								<a onClick={this.onOpenModal} className="ca_button ca_transparent_blue ca_button_book">{theMeta(data.bottomBlock, 'Media > Bottom > Buttons > Right').referenceData[0].text.text}</a>
							</div>
							<div className="col-12 col-md-1"></div>
						</div>
					</div>
