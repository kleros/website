...
import styles from "./styles/incubator-card.module.css";
import Countdown from "react-countdown-now";
import { Card } from "react-bootstrap";

const IncubatorCard = ({ intl, content }) => (
  <div className={styles.incubatorCard} style={{ backgroundColor: `${content.color}` }}>
...
export default injectIntl(IncubatorCard);
