        ...
        <Container className={styles.bottomContainer}>
          <Row className={styles.social}>
            <a className="g-kleros_footer__anchor" rel="noopener noreferrer" target="_blank" href="https://github.com/kleros">
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" className="g-kleros_footer__icon svg-inline--fa fa-github fa-w-16" role="img" viewBox="0 0 496 512">
                <path
            ...
            <a className="g-kleros_footer__anchor" href="https://slack.kleros.io/" rel="noopener noreferrer" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="slack" className="g-kleros_footer__icon svg-inline--fa fa-slack fa-w-14" role="img" viewBox="0 0 448 512">
                <path
                  className="g-kleros_footer__icon--filled"
            ...
            <a className="g-kleros_footer__anchor" href="https://reddit.com/r/Kleros/" rel="noopener noreferrer" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="reddit-alien" className="g-kleros_footer__icon svg-inline--fa fa-reddit-alien fa-w-16" role="img" viewBox="0 0 512 512">
                <path
                  className="g-kleros_footer__icon--filled"
            ...
            <a className="g-kleros_footer__anchor" href="https://twitter.com/kleros_io?" rel="noopener noreferrer" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" className="g-kleros_footer__icon svg-inline--fa fa-twitter fa-w-16" role="img" viewBox="0 0 512 512">
                <path
                  className="g-kleros_footer__icon--filled"
            ...
            <a className="g-kleros_footer__anchor" href="https://blog.kleros.io/" rel="noopener noreferrer" target="_blank">
              <svg className="g-kleros_footer__icon" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="0.153076" y="0.152344" width="9.81887" height="3.4366" rx="1.5" className="g-kleros_footer__icon--filled"></rect>
                <rect x="13.4084" y="0.152344" width="3.4366" height="3.4366" rx="1.5" className="g-kleros_footer__icon--filled"></rect>
                <rect x="9.97168" y="13.4082" width="6.87321" height="3.4366" rx="1.5" className="g-kleros_footer__icon--filled"></rect>
                <rect x="0.152832" y="13.4082" width="6.87321" height="3.4366" rx="1.5" className="g-kleros_footer__icon--filled"></rect>
                <rect x="0.152832" y="6.53516" width="16.6921" height="3.4366" rx="1.5" className="g-kleros_footer__icon--filled"></rect>
              </svg>
            </a>

            <a className="g-kleros_footer__anchor" href="https://t.me/kleros" rel="noopener noreferrer" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="telegram-plane" className="g-kleros_footer__icon svg-inline--fa fa-telegram-plane fa-w-24" role="img" viewBox="0 0 448 512">
                <path
                  className="g-kleros_footer__icon--filled"
            ...
            <a className="g-kleros_footer__anchor" href="https://www.linkedin.com/company/kleros/" rel="noopener noreferrer" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in" className="g-kleros_footer__icon svg-inline--fa fa-linkedin-in fa-w-14" role="img" viewBox="0 0 448 512">
                <path
                  className="g-kleros_footer__icon--filled"
